...
def somigliana(phi):
    ...
    '''
    # WSG parameters
    a = 6378137.0 # the semimajor axis [m]
    f = 1.0/298.257223563 # the flattening
    GM = 3986004.418*(10**8) # the geocentric gravitational constant of the Earth [m**3/s**2]
    omega = 7292115*(10**-11) # the angular velocity [rad/s]
...
def plotting(projecao, x, y, dado, area, unidade, titulo, cores, tamanho,
               delta, perfis=None, estados=None, escala=True, eixos=True):
    '''
